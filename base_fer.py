...
parser.add_argument('--data_path', default='./data/RAFDB/', help='path to dataset')
parser.add_argument('--eval_only', default=False, action='store_true')
parser.add_argument('--eval_ckpt', default="./weight/model/BASE_MTL_RAFDB_model_best.pth",
...
parser.add_argument('--arch', default='BASELINE_RAFDB', type=str, help='model type for train')
...
parser.add_argument('--lr', default=2.5e-3, type=float, help='initial learning rate')
...
parser.add_argument('--seed', default=100001, type=int)
...
def main(args):
    ...
    train_dataset = datasets.ImageFolder(root=os.path.join(args.data_path, 'train'),
                                         transform=transforms.Compose([
                                             ...
                                             transforms.RandomErasing(p=0.5, scale=(0.05, 0.15))]))
